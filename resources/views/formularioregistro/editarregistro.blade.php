                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if ($errors->has('email'))
                                            <p class="text-danger">{{ $errors->first('email') }}"{{ old('email') }}"
                                            </p>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        @if ($errors->has('cedula'))
                                            <p class="text-danger">{{ $errors->first('cedula') }}"{{ old('cedula') }}"
                                            </p>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="id_medico" class="form-control" required>
                                            <option value="{{ $paciente->id_medico }}">{{ $medicoBD->nombres }}
                                            </option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="cantidad_familia" required
                                            max="99" min="0" value="{{ $paciente->cantidad_familia }}" maxlength="2"
                                            oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="zona_vive" class="form-control" required>
                                            <option value="{{ $paciente->zona_vive }}">{{ $paciente->zona_vive }}
                                            </option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="tipo_vivienda" class="form-control" required>
                                            <option value="{{ $paciente->tipo_vivienda }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="personas_aportan_familia"
                                            required max="99" min="0" value="{{ $paciente->personas_aportan_familia }}"
                                            maxlength="2"
                                            oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="id_situacion_jefe_hogar" class="form-control" required>
                                            <option value="{{ $paciente->id_situacion_jefe_hogar }}">
                                                {{ $situacionJefeHogarBD->situacion }}</option>
                                            @foreach ($situacionJefeHogar as $jefeHogar)
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="id_problema_diabetes" class="form-control" required>
                                            <option value="{{ $paciente->id_problema_diabetes }}">
                                                {{ $problemaDiabetesBD->problema }}</option>
